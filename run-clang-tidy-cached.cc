...
static constexpr std::string_view kProjectCachePrefix = "";
static constexpr std::string_view kStartDirectory = ".";  // e.g. src/
...
static constexpr std::string_view kFileExcludeRe = //
    ...
    "|^build/|submodules/" // Other typical names of directories to exclude.
    ;
...
static constexpr std::string_view kToplevelBuild = ".clang-tidy";
